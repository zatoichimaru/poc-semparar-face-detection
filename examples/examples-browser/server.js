...
app.post('/webcam_face_detection', async (req, res) => {
  ...
  connection.connect(function(err) {
    ...
    let sql = "INSERT INTO face_position (face_position_x,face_position_y,face_position_width,face_position_height) VALUES ('" + req.body.body.face_position_x + "','"+ req.body.body.face_position_y + "','"+ req.body.body.face_position_width + "','"+ req.body.body.face_position_height + "')";
