...
function renderNavBar(navbarId, exampleUri) {
  const examples = [
    ...
    },
    {
      ...
      name: 'Detecta contorno facial '
    },
    {
      uri: 'webcam_face_expression_recognition',
      name: 'Detecta as expressões'
    },
    {
      uri: 'webcam_age_and_gender_recognition',
      name: 'Detecta a idade aproximada'
    }
  ]
...
async function saveFace(body) {
  await fetch('webcam_face_detection', {
    method: 'post',
    headers: {
      'content-type': 'application/json'
    },
